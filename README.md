...
```
sudo pacman -S plasma konsole dolphin ark kate kcalc krunner partitionmanager packagekit-qt5 plasma-nm plasma-pa sddm-kcm plasma-pantfs-3g aspell-ru aspell-en ufw openssh
```
Пакеты | Описание
--------- | ----------
