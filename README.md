...
```
sudo pacman -S chromium openssh qbittorrent audacious screen wget git neofetch plasma-browser-integration sddm-kcm telegram-desktop cups print-manager system-config-printer
